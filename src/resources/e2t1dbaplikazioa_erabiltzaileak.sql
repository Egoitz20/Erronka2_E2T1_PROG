...
CREATE TABLE `erabiltzaileak` (
  `iderabiltzaileak` int NOT NULL,
  `izena` varchar(45) DEFAULT NULL,
  `pasahitza` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`iderabiltzaileak`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Aplikaziaren erabiltzaileen taula eta beren pasahitzak';
...
INSERT INTO `erabiltzaileak` VALUES (1,'egoitz','egoitz'),(2,'ane','ane'),(3,'imanol','imanol'),(4,'zunbeltz','zunbeltz');
...
-- Dump completed on 2025-12-01 13:53:01
